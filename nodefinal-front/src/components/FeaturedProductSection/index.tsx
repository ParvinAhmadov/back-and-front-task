import { FeaturedSectionProps } from "@/types/types";
import Image from "next/image";
import React from "react";
import { IoHeartOutline, IoSearchOutline } from "react-icons/io5";
import { SlRefresh } from "react-icons/sl";

const FeaturedProductSection: React.FC<FeaturedSectionProps> = ({
  Feabrand,
  Featitle,
  Feaprice,
  FeaimageUrl1,
  ...
  return (
    <div className="group">
      ...
      <div className="flex justify-center flex-col items-center">
        <p className="text-[14px] uppercase text-gray-400">{Feabrand}</p>
        <p className="text-[18px]">{Featitle}</p>
